...
type Platform interface {
	...
	CreateContainer(c *elr.Container) error
	StartContainer(c *elr.Container) error
	StopContainer(c *elr.Container) error
	PauseContainer(c *elr.Container) error
	UnpauseContainer(c *elr.Container) error
	DeleteContainer(c *elr.Container) error
	// 文件系统隔离方法
	SetupFileSystemIsolation(c *elr.Container) error
	MountFileSystem(c *elr.Container) error
	UnmountFileSystem(c *elr.Container) error
}
