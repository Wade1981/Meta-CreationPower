...
echo ====================================
echo Creating ELR Installer as Zip Archive
echo ====================================

:: Set variables
set installerName=elr-installer.zip
...
echo Write-Host "Installation Script">> "%tempDir%\install.ps1"
echo Write-Host "====================================">> "%tempDir%\install.ps1"
echo.>> "%tempDir%\install.ps1"
...
echo     Copy-Item "$currentDir\lib\*" $libDir -Recurse -Force>> "%tempDir%\install.ps1"
...
echo # ELR Container Installer>> "%tempDir%\README.md"
...
echo - Python 3.8+ (optional, for running Python scripts)>> "%tempDir%\README.md"
echo - GCC (optional, for compiling C programs)>> "%tempDir%\README.md"
echo.>> "%tempDir%\README.md"
...
echo.>> "%tempDir%\README.md"
echo ### GCC Not Found>> "%tempDir%\README.md"
echo If you need to compile C programs, install GCC through one of these methods:>> "%tempDir%\README.md"
echo - MinGW-w64: https://www.mingw-w64.org/>> "%tempDir%\README.md"
echo - MSYS2: https://www.msys2.org/>> "%tempDir%\README.md"
echo - Cygwin: https://www.cygwin.com/>> "%tempDir%\README.md"
echo.>> "%tempDir%\README.md"
echo ### Network Issues>> "%tempDir%\README.md"
echo If you have network connectivity issues, check your firewall settings and ensure you can access GitHub.>> "%tempDir%\README.md"
echo.>> "%tempDir%\README.md"
...
if exist "%outputDir%\%installerName%" (
    echo ====================================
    echo ELR Installer Zip Archive created successfully!
    echo ====================================
