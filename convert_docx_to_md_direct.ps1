...
.DESCRIPTION
    此脚本使用PowerShell的Expand-Archive cmdlet来解压缩Word文档，
    然后直接读取和解析其中的XML内容，无需安装Python或Microsoft Word。
...
.EXAMPLE
    .\convert_docx_to_md_direct.ps1 -InputFile "docs\程序员称谓衍进数智工程师.docx"

.EXAMPLE
    .\convert_docx_to_md_direct.ps1 -InputFile "docs\程序员称谓衍进数智工程师.docx" -OutputFile "docs\程序员称谓衍进数智工程师.md"
#>
...
# 尝试读取和解析Word文档
try {
    Write-Host "正在处理Word文档: $InputFile"
    ...
    $plainText | Set-Content -Path $OutputFile -Encoding UTF8
